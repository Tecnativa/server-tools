odoo.define("base_changeset_tier_validation.PendingTierReviewsField", function (
    ...
    var PendingTierReviewsField = AbstractField.extend({
        ...
        _actionOpenChangesetRef: function (event) {
            ...
            const mapped_line_field_from_model = {
                "purchase.order.line": "order_line",
            };
            if (changeset_ref_model in mapped_line_field_from_model) {
                const field_name = mapped_line_field_from_model[changeset_ref_model];
